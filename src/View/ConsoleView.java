...
public class ConsoleView {
    ...
    private static void addGood (String goodName, boolean isCountable) {
        ...
        if (isCountable){
            ...
            System.out.printf("Uncountable good %s added. Total inventory: %f kg\n", goodName, totalAmount);
        }
    }
    ...
    private static void newOrder(String consumerName){
        ...
        while (true){
            ...
            if (matcher.find()){
                ...
                isCash = getInputInFormat("Do you want to pay with cash or credit?", "^(cash|credit)$")
    ...
    private static void printTotalSales(String option){
